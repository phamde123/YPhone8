...
<main>
    ...
    <section class="tp-login-area pb-140 p-relative z-index-1 fix">
        <div class="tp-login-shape">
            <img class="tp-login-shape-1" src="client/assets/img/login/login-shape-1.png" alt="">
            <img class="tp-login-shape-2" src="client/assets/img/login/login-shape-2.png" alt="">
            <img class="tp-login-shape-3" src="client/assets/img/login/login-shape-3.png" alt="">
            <img class="tp-login-shape-4" src="client/assets/img/login/login-shape-4.png" alt="">
        </div>
        <div class="container">
                ...
                <div class="col-xl-6 col-lg-8">
                    <div class="tp-login-wrapper">
                        <div class="tp-login-top text-center mb-30">
                            ...
                            <p>Don’t have an account? <span><a href="?act=register">Create a free account</a></span></p>
                        </div>
                        <div class="tp-login-option">
                            <div class="tp-login-social mb-10 d-flex flex-wrap align-items-center justify-content-center">
                                <div class="tp-login-option-item has-google">
                                    <a href="#">
                                        <img src="client/assets/img/icon/login/google.svg" alt="">
                                        Sign in with google
                                    </a>
                                </div>
                                <div class="tp-login-option-item">
                                    <a href="#">
                                        <img src="client/assets/img/icon/login/facebook.svg" alt="">
                                    </a>
                                </div>
                                <div class="tp-login-option-item">
                                    <a href="#">
                                        <img class="apple" src="client/assets/img/icon/login/apple.svg" alt="">
                                    </a>
                                </div>
                            </div>
