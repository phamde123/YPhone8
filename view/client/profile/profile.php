                                            ...
                                            <form action="?act=update-profile" method="post">
                                                <div class="row">
                                                    <div class="col-xxl-6 col-md-6">
                                                        <div class="profile__input-box">
                                                            <div class="profile__input">
                                                                <input type="text" placeholder="Enter your username" name="name" value="<?= $_SESSION['user']['name'] ?>">
                                                                <span>
                                                    ...
                                                    <div class="col-xxl-6 col-md-6">
                                                        <div class="profile__input-box">
                                                            <div class="profile__input">
                                                                <input type="text" placeholder="Enter your number" name="phone" value="<?= $_SESSION['user']['phone'] ?>">
                                                                <span>
                                                        ...
                                                        <div class="profile__input-box">
                                                            <div class="profile__input">
                                                                <select name="gender">
                                                                    ...
                                                                    <option value="Nu" <?= $_SESSION['user']['gender'] == 'Nu' ? 'selected' : '' ?>>Nu</option>
                                                                </select>
                                                            </div>
                                                    ...
                                                    <div class="col-xxl-12">
                                                        <div class="profile__input-box">
                                                            <div class="profile__input">
                                                                <input type="text" placeholder="Enter your address" name="address" value="<?= $_SESSION['user']['address'] ?>">
                                                                <span>
                                                    ...
                                                    <div class="col-xxl-12">
                                                        <div class="profile__btn">
                                                            <button type="submit" name="update-profile" class="tp-btn">Update Profile</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
