...
<!-- Mirrored from html.storebuild.shop/shofy-prv/shofy/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 05:44:39 GMT -->
...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="client/assets/img/logo/favicon.png">
            ...
            <div id="loading-center-absolute">
                ...
                <div class="tp-preloader-content">
                    <div class="tp-preloader-logo">
                        ...
                        <img src="client/assets/img/logo/preloader/preloader-icon.svg" alt="">
                    </div>
            ...
            <div class="offcanvas__content">
                ...
                <div class="offcanvas__contact align-items-center d-none">
                    <div class="offcanvas__contact-icon mr-20">
                        <span>
                            <img src="client/assets/img/icon/contact.png" alt="">
                        </span>
                    </div>
                    ...
                    <div class="offcanvas__select language">
                        <div class="offcanvas__lang d-flex align-items-center justify-content-md-end">
                            <div class="offcanvas__lang-img mr-15">
                                <img src="client/assets/img/icon/language-flag.png" alt="">
                            </div>
                ...
                <div class="container">
                    <div class="row align-items-center">
                        <div class="col-xl-2 col-lg-2 col-md-4 col-6">
                            <div class="logo">
                                <a href="index.html">
                                    <img src="client/assets/img/logo/logo-yphone.png" alt="logo" width="180px">
                                </a>
                            </div>
                        </div>
                                            ...
                                            <li class="has-dropdown">
                                                ...
                                                <ul class="mega-menu tp-submenu">
                                                    <li>
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <a href="shop.html"><img src="client/assets/img/header/menu/menu-1.jpg" alt=""></a>
                                                            </li>
                                                            <li>
                                                    ...
                                                    <li>
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <a href="shop.html"><img src="client/assets/img/header/menu/menu-2.jpg" alt=""></a>
                                                            </li>
                                                            <li>
                                                    ...
                                                    <li>
                                                        ...
                                                        <ul>
                                                            <li>
                                                                <a href="shop.html"><img src="client/assets/img/header/menu/menu-3.jpg" alt=""></a>
                                                            </li>
                                                            <li>
                                                    ...
                                                    <div class="row row-cols-1 row-cols-lg-4 row-cols-xl-5">
                                                            ...
                                                            <div class="home-menu-item ">
                                                                <a href="index.html">
                                                                    <div class="home-menu-thumb p-relative fix">
                                                                        <img src="client/assets/img/menu/menu-home-1.jpg" alt="">
                                                                    </div>
                                                        ...
                                                        <div class="col">
                                                            <div class="home-menu-item ">
                                                                <a href="index-2.html">
                                                                    <div class="home-menu-thumb p-relative fix">
                                                                        <img src="client/assets/img/menu/menu-home-2.jpg" alt="">
                                                                    </div>
                                                                    <div class="home-menu-content">
                                                        ...
                                                        <div class="col">
                                                            <div class="home-menu-item ">
                                                                <a href="index-3.html">
                                                                    <div class="home-menu-thumb p-relative fix">
                                                                        <img src="client/assets/img/menu/menu-home-3.jpg" alt="">
                                                                    </div>
                                                                    <div class="home-menu-content">
                                                        ...
                                                        <div class="col">
                                                            <div class="home-menu-item ">
                                                                <a href="index-4.html">
                                                                    <div class="home-menu-thumb p-relative fix">
                                                                        <img src="client/assets/img/menu/menu-home-4.jpg" alt="">
                                                                    </div>
                                                                    <div class="home-menu-content">
                                                        ...
                                                        <div class="col">
                                                            <div class="home-menu-item ">
                                                                <a href="index-5.html">
                                                                    <div class="home-menu-thumb p-relative fix">
                                                                        <img src="client/assets/img/menu/menu-home-5.jpg" alt="">
                                                                    </div>
                                                                    <div class="home-menu-content">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-3">
                                                            <div class="shop-mega-menu-img">
                                                                <img src="client/assets/img/menu/product/menu-product-img-1.jpg" alt="">
                                                        ...
                                                        <div class="col-lg-3">
                                                            <div class="shop-mega-menu-img">
                                                                <img src="client/assets/img/menu/product/menu-product-img-2.jpg" alt="">
                                                                <div class="shop-mega-menu-btn">
