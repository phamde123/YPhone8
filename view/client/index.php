                                            ...
                                            <div class="tp-product-item p-relative transition-3 mb-25">
                                                <div class="tp-product-thumb p-relative fix m-img">
                                                    <a href="?act=product_detail&slug=<?= $pro['pro_slug'] ?>">
                                                        <img src="./images/product/<?= $pro['pro_image'] ?>" alt="product-electronic">
                                                    </a>
                                                ...
                                                <div class="tp-product-content">
                                                    <div class="tp-product-category">
                                                        <a href="shop.html"><?= $pro['cate_name'] ?></a>
                                                    </div>
                                                    ...
                                                    <div class="tp-product-price-wrapper">
                                                        <span class="tp-product-price old-price">$<?= $pro['pro_price'] ?>.00</span>
                                                        <span class="tp-product-price new-price">$<?= $pro['pro_sale_price'] ?>.00</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div> 
