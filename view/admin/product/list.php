                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="rounded bg-light avatar-md d-flex align-items-center justify-content-center">
                                                    <img src="admin/assets_admin/images/product/p-2.png" alt="" class="avatar-md">
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="rounded bg-light avatar-md d-flex align-items-center justify-content-center">
                                                    <img src="admin/assets_admin/images/product/p-3.png" alt="" class="avatar-md">
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="rounded bg-light avatar-md d-flex align-items-center justify-content-center">
                                                    <img src="admin/assets_admin/images/product/p-4.png" alt="" class="avatar-md">
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="rounded bg-light avatar-md d-flex align-items-center justify-content-center">
                                                    <img src="admin/assets_admin/images/product/p-5.png" alt="" class="avatar-md">
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="rounded bg-light avatar-md d-flex align-items-center justify-content-center">
                                                    <img src="admin/assets_admin/images/product/p-6.png" alt="" class="avatar-md">
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="rounded bg-light avatar-md d-flex align-items-center justify-content-center">
                                                    <img src="admin/assets_admin/images/product/p-7.png" alt="" class="avatar-md">
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="rounded bg-light avatar-md d-flex align-items-center justify-content-center">
                                                    <img src="admin/assets_admin/images/product/p-8.png" alt="" class="avatar-md">
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="rounded bg-light avatar-md d-flex align-items-center justify-content-center">
                                                    <img src="admin/assets_admin/images/product/p-9.png" alt="" class="avatar-md">
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="rounded bg-light avatar-md d-flex align-items-center justify-content-center">
                                                    <img src="admin/assets_admin/images/product/p-10.png" alt="" class="avatar-md">
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="rounded bg-light avatar-md d-flex align-items-center justify-content-center">
                                                    <img src="admin/assets_admin/images/product/p-11.png" alt="" class="avatar-md">
                                                </div>
                                                <div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center gap-2">
                                                <div class="rounded bg-light avatar-md d-flex align-items-center justify-content-center">
                                                    <img src="admin/assets_admin/images/product/p-12.png" alt="" class="avatar-md">
                                                </div>
                                                <div>
