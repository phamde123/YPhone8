                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="status" value="FuturePplan" id="flexRadioDefault11">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="date" id="start-date" class="form-control flatpickr-input active" name="star_date" placeholder="dd-mm-yyyy">
                            </div>
                ...
                <div class="col-lg-7">
                    <div class="card">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="coupons-code" name="name" class="form-control" placeholder="Tên mã giảm giá">
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="coupons-limits" name="coupon_code" class="form-control" placeholder="Mã giảm">
                                    </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="number" id="coupons-limits" name="quantity" class="form-control" placeholder="Số lượng">
                                    </div>
                        ...
                        <div class="card-footer border-top">
                            <button type="submit" name="coupon-create" class="btn btn-primary">Create Coupon</button>
                        </div>
                    </div>
                </div>
            </div>
