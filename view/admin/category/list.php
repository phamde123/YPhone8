            ...
            <div class="col-xl-12">
                <div class="card">
                    <div class="card-header d-flex justify-content-between align-items-center gap-1">
                        ...
                        <a href="index.php?act=category_create" class="btn btn-sm btn-primary">
                            Thêm Danh Mục
                        </a>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-2">
                                                <a href="index.php?act=category_detail&id=<?= $cate["cate_id"] ?>" class="btn btn-light btn-sm"><iconify-icon icon="solar:eye-broken" class="align-middle fs-18"></iconify-icon></a>
                                                <a href="index.php?act=category_edit&id=<?= $cate["cate_id"] ?>" class="btn btn-soft-primary btn-sm"><iconify-icon icon="solar:pen-2-broken" class="align-middle fs-18"></iconify-icon></a>
                                                <a onclick="return confirm('Xóa à ?')" href="index.php?act=category_delete&id=<?= $cate["cate_id"] ?>" class="btn btn-soft-danger btn-sm"><iconify-icon icon="solar:trash-bin-minimalistic-2-broken" class="align-middle fs-18"></iconify-icon></a>
                                            </div>
                                        </td>
                                    </tr>
                                    <?php endforeach; ?>
