...
<!-- Mirrored from techzaa.in/larkon/admin/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 07 Jan 2025 05:53:22 GMT -->
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="sidebarProducts">
                            <ul class="nav sub-navbar-nav">
                                ...
                                <li class="sub-nav-item">
                                    <a class="sub-nav-link" href="index.php?act=product_edit">Edit</a>
                                </li>
                                <li class="sub-nav-item">
                                    <a class="sub-nav-link" href="index.php?act=product_create">Create</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="sidebarCategory">
                            <ul class="nav sub-navbar-nav">
                                ...
                                <li class="sub-nav-item">
                                    <a class="sub-nav-link" href="index.php?act=category_edit">Edit</a>
                                </li>
                                <li class="sub-nav-item">
                                    <a class="sub-nav-link" href="index.php?act=category_create">Create</a>
                                </li>
                            </ul>
                        </div>
                    </li>
